...
public class RedisUtil {
     ...
     * @param key   键
     * @param value 值
     * @param time  过期时间, time 小于等于 0，表示永不失效; time > 0 时，表示time 秒后失效
    ...
    /**
     * 向一张hash表中放入数据，如果不能存在则创建
     *
     * @param key   键
     * @param item  项
     * @param value 值
     * @param time  失效时间
     * @return true:工程; false:失败
     */
